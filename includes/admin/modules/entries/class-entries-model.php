...
if ( ! class_exists( 'Gutena_Forms_Entries_Model' ) ) :
	...
	public function get_all( $form_id = 0 ) {
		...
		// phpcs:ignore PluginCheck.Security.DirectDB.UnescapedDBParameter,WordPress.DB.PreparedSQL.NotPrepared -- $sql is built via $wpdb->prepare() with placeholders; appended fragments are static literals.
