			...
			return array(
				...
				'fields'      => array(
					array(
						...
						'value'   => $this->settings['required_field'],
					),
					array(
						'id'      => 'required_select_field',
						'type'    => 'text',
						...
						'value'   => $this->settings['required_select_field'],
					),
					array(
						'id'      => 'required-checkbox-radio-field',
						'type'    => 'text',
						...
						'value'   => $this->settings['required_checkbox_radio_field'],
					),
					array(
						'id'      => 'required-optin-field',
						'type'    => 'text',
						...
						'value'   => $this->settings['required_optin_field'],
					),
					array(
						'id'      => 'invalid_email',
						'type'    => 'text',
						...
						'value'   => $this->settings['invalid_email'],
					),
					array(
						'id'      => 'min_value',
						'type'    => 'text',
