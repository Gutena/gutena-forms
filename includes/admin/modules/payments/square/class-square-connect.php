...
if ( ! class_exists( 'Gutena_Forms_Square_Connect' ) ) :
	class Gutena_Forms_Square_Connect {
		...
		const OAUTH_SCOPES = 'MERCHANT_PROFILE_READ PAYMENTS_READ PAYMENTS_WRITE ORDERS_READ ORDERS_WRITE CUSTOMERS_READ CUSTOMERS_WRITE ITEMS_READ ITEMS_WRITE SUBSCRIPTIONS_READ SUBSCRIPTIONS_WRITE INVOICES_READ INVOICES_WRITE';
