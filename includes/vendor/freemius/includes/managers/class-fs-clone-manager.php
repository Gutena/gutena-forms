<?php
    ...
    class FS_Clone_Manager {
        ...
        function maybe_run_clone_resolution() {
            ...
            $handler_id               = ( - fs - clone-manager . phprand() . microtime() );
        ...
        private function add_manual_clone_resolution_admin_notice(
            ...
            $new_website = sprintf(
	            ...
	            - fs - clone-manager . phpfs_esc_html_inline( 'Yes, %2$s is a new and different website that is separate from %4$s.', 'new-site-message' ) .
	            ( $is_premium ?
