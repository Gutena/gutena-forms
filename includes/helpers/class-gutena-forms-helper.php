	...
	class Gutena_Forms_Helper {
		...
		private static function find_post_id_by_form_id( $form_id ) {
			$posts = get_posts(
				...
				'meta_value'             => $form_id, // phpcs:ignore WordPress.DB.SlowDBQuery.slow_db_query_meta_value -- necessary lookup by the plugin's own gutena_form_id meta key; limited to 1 result.
					'fields'                 => 'ids',
					'no_found_rows'          => true,
