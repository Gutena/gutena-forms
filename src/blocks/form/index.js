...
// Hide legacy field blocks from the inserter (backward compatibility only).
domReady( () => {
	if ( typeof wp !== 'undefined' && typeof wp.data !== 'undefined' ) {
		/** @see https://github.com/WordPress/gutenberg/issues/14139 */
		const hiddenFieldTypes = [
			...( typeof gutenaFormsBlock !== 'undefined' &&
			Array.isArray( gutenaFormsBlock.legacyHiddenBlocks )
				? gutenaFormsBlock.legacyHiddenBlocks
				: [] ),
			'gutena/existing-forms',
		];

		if ( hiddenFieldTypes.length ) {
