if ( ! gutenaFormsBlock.is_pro ) {
	setInterval( function () {
		var elements;
		elements = [
			'editor-block-list-item-gutena-date-field',
			'editor-block-list-item-gutena-time-field',
			'editor-block-list-item-gutena-phone-field',
			'editor-block-list-item-gutena-country-field',
			'editor-block-list-item-gutena-state-field',
			'editor-block-list-item-gutena-file-upload-field',
			'editor-block-list-item-gutena-url-field',
		...
		const strContains = ( str, substr ) => ( String( str ).indexOf( substr ) !== -1 )
