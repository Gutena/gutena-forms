...
import { OneColumnBasicIcon, OneColumnModernIcon, TwoColumnBasicIcon, TwoColumnModernIcon } from './icons';
	...
	innerBlocks: [
		[
			'gutena/text-field',
			{
				nameAttr: 'f_0',
				isRequired: true,
				fieldName: __( 'First name', 'gutena-forms' ),
				fieldType: 'text',
		...
		[
			'gutena/text-field',
			{
				nameAttr: 'f_1',
				isRequired: true,
				fieldName: __( 'Last name', 'gutena-forms' ),
				fieldType: 'text',
		...
		[
			'gutena/text-field',
			{
				nameAttr: 'f_3',
				isRequired: true,
				fieldName: __( 'Subject', 'gutena-forms' ),
				fieldType: 'text',
		...
		[
			'gutena/textarea-field',
			{
				nameAttr: 'f_4',
				isRequired: true,
				fieldName: __( 'Message', 'gutena-forms' ),
				fieldType: 'textarea',
				textAreaRows: 5,
