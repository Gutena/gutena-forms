...
export default function Edit( { attributes, setAttributes, clientId } ) {
	...
	const blockProps = useBlockProps( {
		className: `wp-block-gutena-field-group wp-block-gutena-text-field field-group-type-text standalone-text-field` + ( attributes.conditionalLogic && attributes.conditionalLogic.enabled ? ' has-conditional-logic' : '' ),
	} );
