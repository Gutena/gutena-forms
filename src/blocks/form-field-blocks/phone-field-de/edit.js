		...
		<>
			<InspectorControls>
				<PanelBody title={ __( 'Field settings', 'gutena-forms' ) } initialOpen={ true }>
					...
					<RangeControl label={ __( 'Maxlength', 'gutena-forms' ) } value={ maxlength ?? 0 } onChange={ ( v ) => setAttributes( { maxlength: v } ) } min={ 0 } max={ 50 } step={ 1 } />
			...
			<div { ...blockProps }>
				...
				<input
					...
					placeholder={ placeholder || __( 'Phone number', 'gutena-forms' ) }
