...
export default function Edit( { attributes, setAttributes, clientId } ) {
	...
	const blockProps = useBlockProps( {
		className:
			'wp-block-gutena-field-group wp-block-gutena-date-field field-group-type-date standalone-date-field',
	} );
		...
		<>
			<InspectorControls>
				...
				>
					...
					<TextControl
						...
						help={ __( 'YYYY-MM-DD', 'gutena-forms' ) }
					/>
					<TextControl
			...
			<div { ...blockProps }>
				...
				<input
					...
					name={ nameAttr }
					type="date"
					className={ `gutena-forms-field date-field ${
				...
				{ ! gfIsEmpty( description ) && (
					<p className="gutena-forms-date-field-description">
						{ description }
					</p>
				) }
