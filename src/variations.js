...
const variations = [
	...
	// i need another variation for existing forms, that contains the select field for existing forms when I select one of them than it will fetch that form from the database and show the form in the editor
	{
		name: 'existing-forms',
