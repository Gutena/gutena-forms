    ...
    return (
        <PanelBody title={__( 'Messages', 'gutena-forms' ) } initialOpen={ false }>
            <TextControl
                ...
                value={ gfIsEmpty( messages?.required_msg ) ? gutenaFormsBlock?.required_msg : messages?.required_msg }
            ...
            <TextControl
                ...
                value={ gfIsEmpty( messages?.required_msg_select ) ? gutenaFormsBlock?.required_msg_select : messages?.required_msg_select }
            ...
            <TextControl
                ...
                value={ gfIsEmpty( messages?.required_msg_check ) ? gutenaFormsBlock?.required_msg_check : messages?.required_msg_check }
            ...
            <TextControl
                ...
                value={ gfIsEmpty( messages?.required_msg_optin ) ? gutenaFormsBlock?.required_msg_optin : messages?.required_msg_optin }
            ...
            <TextControl
                ...
                value={ gfIsEmpty( messages?.invalid_email_msg ) ? gutenaFormsBlock?.invalid_email_msg : messages?.invalid_email_msg }
            ...
            <TextControl
                ...
                value={ gfIsEmpty( messages?.min_value_msg ) ? gutenaFormsBlock?.min_value_msg : messages?.min_value_msg }
            ...
            <TextControl
                ...
                value={ gfIsEmpty( messages?.max_value_msg ) ? gutenaFormsBlock?.max_value_msg : messages?.max_value_msg }
