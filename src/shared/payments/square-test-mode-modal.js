		...
		>
			...
			>
				...
				<div className="gutena-forms__square-test-modal__alert">
					<InfoIcon />
					<p>
						{ __( 'Important: Please complete all steps below. Skipping them may cause issues during setup.', 'gutena-forms' ) }
					</p>
				</div>
				...
				<ol className="gutena-forms__square-test-modal__steps">
					<li>
						{ createInterpolateElement(
							__( 'Click <link>here</link> to create a Square account (if you don\'t already have one).', 'gutena-forms' ),
							{
								link: (
									<a
					...
					<li>
						{ createInterpolateElement(
							__( 'Click <link>here</link> to create a Square Sandbox (test) account.', 'gutena-forms' ),
							{
								link: (
									<a
					...
					<li>
						{ __( 'Open your Square Dashboard and switch to the Sandbox/Test mode.', 'gutena-forms' ) }
					</li>
					<li>
						{ createInterpolateElement(
							__( 'Click <link>here</link> to connect your Square account and grant the required permissions.', 'gutena-forms' ),
							{
								link: (
									<button
										type="button"
