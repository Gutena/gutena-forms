...
if ( ! class_exists( 'Gutena_Forms' ) ) :
	...
	class Gutena_Forms {
		...
		private function includes() {
			...
			include_once GUTENA_FORMS_DIR_PATH . 'includes/helpers/class-gutena-forms-form-confirmation-helper.php';
		...
		public function register_blocks_and_scripts() {
			...
			wp_localize_script(
				...
				array_merge(
					...
					'form_confirmation_defaults'    => class_exists( 'Gutena_Forms_Form_Confirmation_Helper' )
						? Gutena_Forms_Form_Confirmation_Helper::get_global_settings()
						: array(),
